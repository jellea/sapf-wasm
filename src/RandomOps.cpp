...
struct NRand : NTwoInputGen<NRand> {
  ...
  NRand(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputGen<NRand>(th, n, a, b) {
    r.init(th.rgen.trand());
  }
...
struct NRandz : NTwoInputUGen<NRandz> {
  ...
  NRandz(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputUGen<NRandz>(th, n, a, b) {
    r.init(th.rgen.trand());
  }
...
struct NIRand : NTwoInputGen<NIRand> {
  ...
  NIRand(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputGen<NIRand>(th, n, a, b) {
    r.init(th.rgen.trand());
  }
...
struct NIRandz : NTwoInputUGen<NIRandz> {
  ...
  NIRandz(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputUGen<NIRandz>(th, n, a, b) {
    r.init(th.rgen.trand());
  }
...
struct ExcRand : TwoInputGen<ExcRand> {
  ...
  ExcRand(Thread& th, Arg a, Arg b)
      : TwoInputGen<ExcRand>(th, a, b), prev(INT32_MIN) {
    r.init(th.rgen.trand());
  }
...
struct ExcRandz : TwoInputUGen<ExcRandz> {
  ...
  ExcRandz(Thread& th, Arg a, Arg b)
      : TwoInputUGen<ExcRandz>(th, a, b), prev(INT32_MIN) {
    r.init(th.rgen.trand());
  }
...
struct NExcRand : NTwoInputGen<NExcRand> {
  ...
  NExcRand(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputGen<NExcRand>(th, n, a, b), prev(INT32_MIN) {
    r.init(th.rgen.trand());
  }
...
struct NExcRandz : NTwoInputUGen<NExcRandz> {
  ...
  NExcRandz(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputUGen<NExcRandz>(th, n, a, b), prev(INT32_MIN) {
    r.init(th.rgen.trand());
  }
...
struct NExpRand : NTwoInputGen<NExpRand> {
  ...
  NExpRand(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputGen<NExpRand>(th, n, a, b) {
    r.init(th.rgen.trand());
  }
...
struct NExpRandz : NTwoInputUGen<NExpRandz> {
  ...
  NExpRandz(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputUGen<NExpRandz>(th, n, a, b) {
    r.init(th.rgen.trand());
  }
...
struct NILinRand : NTwoInputGen<NILinRand> {
  ...
  NILinRand(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputGen<NILinRand>(th, n, a, b) {
    r.init(th.rgen.trand());
  }
...
struct NILinRandz : NTwoInputUGen<NILinRandz> {
  ...
  NILinRandz(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputUGen<NILinRandz>(th, n, a, b) {
    r.init(th.rgen.trand());
  }
...
struct NLinRand : NTwoInputGen<NLinRand> {
  ...
  NLinRand(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputGen<NLinRand>(th, n, a, b) {
    r.init(th.rgen.trand());
  }
...
struct NLinRandz : NTwoInputUGen<NLinRandz> {
  ...
  NLinRandz(Thread& th, int64_t n, Arg a, Arg b)
      : NTwoInputUGen<NLinRandz>(th, n, a, b) {
    r.init(th.rgen.trand());
  }
...
struct RandomAccessNoise : OneInputUGen<RandomAccessNoise> {
  ...
  RandomAccessNoise(Thread& th, Arg a)
      : OneInputUGen<RandomAccessNoise>(th, a) {}
...
struct Pick : ZeroInputGen<Pick> {
  ...
  Pick(Thread& th, P<Array> const& array)
      : ZeroInputGen<Pick>(th, false), _array(array) {
    r.init(th.rgen.trand());
  }
...
struct Pickz : ZeroInputUGen<Pickz> {
  ...
  Pickz(Thread& th, P<Array> const& array)
      : ZeroInputUGen<Pickz>(th, false), _array(array) {
    r.init(th.rgen.trand());
  }
...
struct NPick : NZeroInputGen<NPick> {
  ...
  NPick(Thread& th, int64_t n, P<Array> const& array)
      : NZeroInputGen<NPick>(th, n), _array(array) {
    r.init(th.rgen.trand());
  }
...
struct NPickz : NZeroInputUGen<NPickz> {
  ...
  NPickz(Thread& th, int64_t n, P<Array> const& array)
      : NZeroInputUGen<NPickz>(th, n), _array(array) {
    r.init(th.rgen.trand());
  }
...
static void picks_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("picks : list must be finite", "");
...
static void pickz_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("pickz : list must be finite", "");
...
static void npicks_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("npicks : list must be finite", "");
...
static void npickz_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("npickz : list must be finite", "");
...
static void pick_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("pick : list must be finite", "");
...
struct WPick : ZeroInputGen<WPick> {
  ...
  WPick(Thread& th, P<Array> const& array, P<Array> const& weights)
      : ZeroInputGen<WPick>(th, false), _array(array), _weights(weights) {
    r.init(th.rgen.trand());
  }
...
struct WPickz : ZeroInputUGen<WPickz> {
  ...
  WPickz(Thread& th, P<Array> const& array, P<Array> const& weights)
      : ZeroInputUGen<WPickz>(th, false), _array(array), _weights(weights) {
    r.init(th.rgen.trand());
  }
...
struct NWPick : NZeroInputGen<NWPick> {
  ...
  NWPick(Thread& th, int64_t n, P<Array> const& array, P<Array> const& weights)
      : NZeroInputGen<NWPick>(th, n), _array(array), _weights(weights) {
    r.init(th.rgen.trand());
  }
...
struct NWPickz : NZeroInputUGen<NWPickz> {
  ...
  NWPickz(Thread& th, int64_t n, P<Array> const& array, P<Array> const& weights)
      : NZeroInputUGen<NWPickz>(th, n), _array(array), _weights(weights) {
    r.init(th.rgen.trand());
  }
...
static void wpicks_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("wpicks : list must be finite", "");
  if (!w->isFinite()) indefiniteOp("wpicks : weights must be finite", "");
...
static void wpickz_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("wpickz : list must be finite", "");
  if (!w->isFinite()) indefiniteOp("wpickz : weights must be finite", "");
...
static void nwpicks_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("nwpicks : list must be finite", "");
  if (!w->isFinite()) indefiniteOp("nwpicks : weights must be finite", "");
...
static void nwpickz_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("nwpickz : list must be finite", "");
  if (!w->isFinite()) indefiniteOp("nwpickz : weights must be finite", "");
...
static void wpick_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("wpick : list must be finite", "");
  if (!w->isFinite()) indefiniteOp("wpick : weights must be finite", "");
...
struct WRand : ZeroInputGen<WRand> {
  ...
  WRand(Thread& th, P<Array> const& weights)
      : ZeroInputGen<WRand>(th, false), _weights(weights) {
    r.init(th.rgen.trand());
  }
...
struct WRandz : ZeroInputUGen<WRandz> {
  ...
  WRandz(Thread& th, P<Array> const& weights)
      : ZeroInputUGen<WRandz>(th, false), _weights(weights) {
    r.init(th.rgen.trand());
  }
...
struct NWRand : NZeroInputGen<NWRand> {
  ...
  NWRand(Thread& th, int64_t n, P<Array> const& weights)
      : NZeroInputGen<NWRand>(th, n), _weights(weights) {
    r.init(th.rgen.trand());
  }
...
struct NWRandz : NZeroInputUGen<NWRandz> {
  ...
  NWRandz(Thread& th, int64_t n, P<Array> const& weights)
      : NZeroInputUGen<NWRandz>(th, n), _weights(weights) {
    r.init(th.rgen.trand());
  }
...
static void wrands_(Thread& th, Prim* prim) {
  ...
  if (!w->isFinite()) indefiniteOp("wrands : weights must be finite", "");
...
static void wrandz_(Thread& th, Prim* prim) {
  ...
  if (!w->isFinite()) indefiniteOp("wrandz : weights must be finite", "");
...
static void nwrands_(Thread& th, Prim* prim) {
  ...
  if (!w->isFinite()) indefiniteOp("nwrands : weights must be finite", "");
...
static void nwrandz_(Thread& th, Prim* prim) {
  ...
  if (!w->isFinite()) indefiniteOp("nwrandz : weights must be finite", "");
...
static void wrand_(Thread& th, Prim* prim) {
  ...
  if (!w->isFinite()) indefiniteOp("wrand : weights must be finite", "");
...
struct Gray64Noise : OneInputUGen<Gray64Noise> {
  ...
  Gray64Noise(Thread& th, Arg a)
      : OneInputUGen<Gray64Noise>(th, a), counter_(0) {
    r.init(th.rgen.trand());
  }
...
struct PinkNoise : Gen {
  ...
  PinkNoise(Thread& th, Arg a) : Gen(th, itemTypeZ, a.isFinite()), _a(a) {
    total_ = 0;
    RGen& r = th.rgen;
    for (int i = 0; i < 16; ++i) {
...
struct PinkNoise0 : Gen {
  ...
  PinkNoise0(Thread& th, Arg a) : Gen(th, itemTypeZ, a.isFinite()), _a(a) {
    total_ = 0;
    for (int i = 0; i < 16; ++i) {
      dice[i] = 0;
    }
...
struct BrownNoise : Gen {
  ...
  BrownNoise(Thread& th, Arg a) : Gen(th, itemTypeZ, a.isFinite()), _a(a) {
    total_ = 0;
    RGen& r = th.rgen;
    total_ = r.drand2();
  }
...
struct Dust : Gen {
  ...
  Dust(Thread& th, Arg density, Arg amp)
      : Gen(th, itemTypeZ, mostFinite(density, amp)),
        _density(density),
        _amp(amp),
        _densmul(th.rate.invSampleRate) {}
  ...
  virtual void pull(Thread& th) override {
    ...
    while (framesToFill) {
      ...
      Z *density, *amp;
      if (_density(th, n, densityStride, density) ||
          _amp(th, n, ampStride, amp)) {
        setDone();
        break;
      } else {
        for (int i = 0; i < n; ++i) {
...
static inline double HashRand(int64_t i) {
  ...
  u.i = 0x3FF0000000000000LL |
        ((uint64_t)(Hash64(i) + Hash64bad(i)) & 0x000FffffFFFFffffLL);
  return u.f - 1.;
}
...
struct Toosh : Gen {
  ...
  Toosh(Thread& th, Arg delay, Arg amp)
      : Gen(th, itemTypeZ, mostFinite(delay, amp)),
        _delay(delay),
        _amp(amp),
        sampleRate(th.rate.sampleRate) {
...
struct Crackle : Gen {
  ...
  Crackle(Thread& th, Arg param)
      : Gen(th, itemTypeZ, param.isFinite()),
        _param(param),
        _y1(th.rgen.drand()),
        _y2(0.) {}
...
void AddRandomOps() {
  ...
  DEFAM(rand, kk,
        "(a b --> r) return a uniformly distributed random real value from a "
        "to b.")
  DEFAM(coin, k,
        "(p --> r) return 1 with probability p, or 0 with probability (1-p).")
  DEFAM(rand2, k,
        "(a --> r) return a uniformly distributed random real value from -a to "
        "+a.")
  DEFAM(irand, kk,
        "(a b --> r) return a uniformly distributed random integer value from "
        "a to b.")
  DEFAM(irand2, k,
        "(a --> r) return a uniformly distributed random real value from -a to "
        "+a.")
  DEFAM(xrand, kk,
        "(a b --> r) return a exponentially distributed random real value from "
        "a to b.")
  DEFAM(linrand, kk,
        "(a b --> r) return a linearly distributed random real value from a to "
        "b.")
  DEFAM(ilinrand, kk,
        "(a b --> r) return a linearly distributed random integer value from a "
        "to b.")
  DEF(wrand, 1, 1,
      "(w --> r) return a randomly chosen index from a list of probability "
      "weights. w should sum to one.")
  DEF(pick, 1, 1,
      "(a --> r) return a randomly chosen element from the finite list a.")
  DEF(wpick, 2, 1,
      "(a w --> r) return a randomly chosen element from the finite list a "
      "using probability weights from w. w must be the same length as a and "
      "should sum to one.")

  vm.addBifHelp("\n*** random streams ***");
  DEFAM(rands, kk,
        "(a b --> r) return a stream of uniformly distributed random real "
        "values from a to b.")
  DEFAM(coins, k,
        "(p --> r) return a stream of 1 with probability p, or 0 with "
        "probability (1-p).")
  DEFAM(eprands, kk,
        "(a b --> r) return a stream of uniformly distributed random integer "
        "values from a to b, excluding the previously returned value.")
  DEFAM(rand2s, k,
        "(a --> r) return a stream of uniformly distributed random real values "
        "from -a to +a.")
  DEFAM(irands, kk,
        "(a b --> r) return a stream of uniformly distributed random integer "
        "values from a to b.")
  DEFAM(irand2s, k,
        ...
        "from -a to +a.")
  DEFAM(xrands, kk,
        "(a b --> r) return a stream of exponentially distributed random real "
        "values from a to b.")
  DEFAM(linrands, kk,
        "(a b --> r) return a stream of linearly distributed random real "
        "values from a to b.")
  DEFAM(ilinrands, kk,
        "(a b --> r) return a stream of linearly distributed random integer "
        "values from a to b.")
  DEF(wrands, 1, 1,
      "(w --> r) return a stream of randomly chosen indices from a list of "
      "probability weights. w should sum to one.")
  DEF(picks, 1, 1,
      "(a --> r) return a stream of randomly chosen elements from the finite "
      "list a.")
  DEF(wpicks, 2, 1,
      "(a w --> r) return a stream of randomly chosen elements from the finite "
      "list a using probability weights from w. w must be the same length as a "
      "and should sum to one.")

  vm.addBifHelp("\n*** random signals ***");
  DEFMCX(randz, 2,
         "(a b --> r) return a signal of uniformly distributed random real "
         "values from a to b.")
  DEFMCX(coinz, 1,
         "(p --> r) return a signal of 1 with probability p, or 0 with "
         "probability (1-p).")
  DEFMCX(eprandz, 2,
         "(a b --> r) return a signal of uniformly distributed random integer "
         "values from a to b, excluding the previously returned value")
  DEFMCX(rand2z, 1,
         "(a --> r) return a signal of uniformly distributed random real "
         "values from -a to +a.")
  DEFMCX(irandz, 2,
         "(a b --> r) return a signal of uniformly distributed random integer "
         "values from a to b.")
  DEFMCX(irand2z, 1,
         ...
         "values from -a to +a.")
  DEFMCX(xrandz, 2,
         "(a b --> r) return a signal of exponentially distributed random real "
         "values from a to b.")
  DEFMCX(linrandz, 2,
         "(a b --> r) return a signal of linearly distributed random real "
         "values from a to b.")
  DEFMCX(ilinrandz, 2,
         "(a b --> r) return a signal of linearly distributed random integer "
         "values from a to b.")
  DEFMCX(wrandz, 1,
         "(w --> r) return a signal of randomly chosen indices from a list of "
         "probability weights. w should sum to one.")
  DEFMCX(pickz, 1,
         "(a --> r) return a signal of randomly chosen elements from the "
         "finite list a.")
  DEFMCX(wpickz, 2,
         "(a w --> r) return a signal of randomly chosen elements from the "
         "finite list a using probability weights from w. w must be the same "
         "length as a and should sum to one.")

  vm.addBifHelp("\n*** finite random streams ***");
  DEFAM(nrands, kkk,
        "(n a b --> r) return a stream of n uniformly distributed random real "
        "values from a to b.")
  DEFAM(ncoins, kk,
        "(n p --> r) return a stream of n 1 with probability p, or 0 with "
        "probability (1-p).")
  DEFAM(neprands, kkk,
        "(n a b --> r) return a stream of n uniformly distributed random "
        "integer values from a to b, excluding the previously returned value.")
  DEFAM(nrand2s, kk,
        "(n a --> r) return a stream of n uniformly distributed random real "
        "values from -a to +a.")
  DEFAM(nirands, kkk,
        "(n a b --> r) return a stream of n uniformly distributed random "
  ...
  DEFAM(nirand2s, kk,
        ...
        "values from -a to +a.")
  DEFAM(nxrands, kkk,
        "(n a b --> r) return a stream of n exponentially distributed random "
        "real values from a to b.")
  DEFAM(nlinrands, kkk,
        "(n a b --> r) return a stream of n linearly distributed random real "
        "values from a to b.")
  DEFAM(nilinrands, kkk,
        "(n a b --> r) return a stream of n linearly distributed random "
        "integer values from a to b.")
  DEFAM(nwrands, ka,
        "(n w --> r) return a stream of n randomly chosen indices from a list "
        "of probability weights. w should sum to one.")
  DEFAM(npicks, ka,
        "(n a --> r) return a stream of n randomly chosen elements from the "
        "finite list a.")
  DEFAM(nwpicks, kaa,
        "(n a w --> r) return a stream of n randomly chosen elements from the "
        "finite list a using probability weights from w. w must be the same "
        "length as a and should sum to one.")

  vm.addBifHelp("\n*** finite random signals ***");
  DEFMCX(nrandz, 3,
         "(n a b --> r) return a signal of n uniformly distributed random real "
         "values from a to b.")
  DEFMCX(ncoinz, 2,
         "(n p --> r) return a signal of n 1 with probability p, or 0 with "
         "probability (1-p).")
  DEFMCX(neprandz, 3,
         "(n a b --> r) return a signal of n uniformly distributed random "
         "integer values from a to b, excluding the previously returned value")
  DEFMCX(nrand2z, 2,
         "(n a --> r) return a signal of n uniformly distributed random real "
         "values from -a to +a.")
  DEFMCX(nirandz, 3,
         "(n a b --> r) return a signal of n uniformly distributed random "
         "integer values from a to b.")
  DEFMCX(nirand2z, 2,
         ...
         "values from -a to +a.")
  DEFMCX(nxrandz, 3,
         "(n a b --> r) return a signal of n exponentially distributed random "
         "real values from a to b.")
  DEFMCX(nlinrandz, 3,
         "(n a b --> r) return a signal of n linearly distributed random real "
         "values from a to b.")
  DEFMCX(nilinrandz, 3,
         "(n a b --> r) return a signal of n linearly distributed random "
         "integer values from a to b.")
  DEFMCX(nwrandz, 2,
         "(n w --> r) return a signal of n randomly chosen indices from a list "
         "of probability weights. w should sum to one.")
  DEFMCX(npickz, 2,
         "(n a --> r) return a signal of n randomly chosen elements from the "
         "finite signal a.")
  DEFMCX(nwpickz, 3,
         "(n a w --> r) return a signal of n randomly chosen elements from the "
         "finite signal a using probability weights from w. w must be the same "
         "length as a and should sum to one.")
  ...
  DEFMCX(
      rawhite, 1,
      "(amp --> z) white noise based on Cessu's random access random numbers")
  DEFMCX(wangwhite, 1,
         "(amp --> z) white noise based on Thomas Wang's integer hash")
  DEFMCX(citywhite, 1,
         "(amp --> z) white noise based on a function from CityHash")
  ...
  DEFMCX(dust, 2,
         "(density amp --> z) a stream of impulses whose amplitude is random "
         "from 0 to a and whose average density is in impulses per second.")
  DEFMCX(dust2, 2,
         "(density amp --> z) a stream of impulses whose amplitude is random "
         "from -a to +a and whose average density is in impulses per second.")
  DEFMCX(velvet, 2,
         "(density amp --> z) a stream of impulses whose amplitude is randomly "
         "either -a or +a and whose average density is in impulses per second.")
  DEFMCX(toosh, 2,
         "(delay amp --> z) flanged noise. difference of two white noise "
         "sources with a delay.")
  DEFMCX(tooshp, 2,
         "(delay amp--> z) flanged noise. sum of two white noise sources with "
         "a delay. no null at delay == 0. ")
