...
static void reverse_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("reverse", "");
...
static List* makeMirror(P<Array> const& a, int64_t n, int64_t nr,
                        int64_t roff) {
  int type = a->elemType;
  int64_t size = n + nr;
...
static void mirror(Thread& th, int w, P<List> s) {
  if (!s->isFinite()) indefiniteOp("mirror", "");
...
static void rot_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("rot", "");
...
static void shift_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("shift", "");
...
static void clipShift_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("clipShift", "");
...
static void foldShift_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("foldShift", "");
...
static void muss_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("muss", "");
...
V do_degkey(Thread& th, P<Array> const& a, Arg b, Z cycleWidth,
            int degreesPerCycle);
V do_keydeg(Thread& th, P<Array> const& a, Arg b, Z cycleWidth,
            int degreesPerCycle);
...
class AtGenVV : public Gen {
 ...
 public:
  AtGenVV(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeV, b.isFinite()), _a(a), _b(b) {}
...
class AtGenVZ : public Gen {
 ...
 public:
  AtGenVZ(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeV, b.isFinite()), _a(a), _b(b) {}
...
class AtGenZZ : public Gen {
 ...
 public:
  AtGenZZ(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeZ, b.isFinite()), _a(a), _b(b) {}
...
class WrapAtGenVV : public Gen {
 ...
 public:
  WrapAtGenVV(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeV, b.isFinite()), _a(a), _b(b) {}
...
class WrapAtGenVZ : public Gen {
 ...
 public:
  WrapAtGenVZ(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeV, b.isFinite()), _a(a), _b(b) {}
...
class WrapAtGenZZ : public Gen {
 ...
 public:
  WrapAtGenZZ(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeZ, b.isFinite()), _a(a), _b(b) {}
...
class FoldAtGenVV : public Gen {
 ...
 public:
  FoldAtGenVV(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeV, b.isFinite()), _a(a), _b(b) {}
...
class FoldAtGenVZ : public Gen {
 ...
 public:
  FoldAtGenVZ(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeV, b.isFinite()), _a(a), _b(b) {}
...
class FoldAtGenZZ : public Gen {
 ...
 public:
  FoldAtGenZZ(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeZ, b.isFinite()), _a(a), _b(b) {}
...
class ClipAtGenVV : public Gen {
 ...
 public:
  ClipAtGenVV(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeV, b.isFinite()), _a(a), _b(b) {}
...
class ClipAtGenVZ : public Gen {
 ...
 public:
  ClipAtGenVZ(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeV, b.isFinite()), _a(a), _b(b) {}
...
class ClipAtGenZZ : public Gen {
 ...
 public:
  ClipAtGenZZ(Thread& th, P<Array> const& a, Arg b)
      : Gen(th, itemTypeZ, b.isFinite()), _a(a), _b(b) {}
...
class DegKeyVV : public Gen {
 ...
 public:
  DegKeyVV(Thread& th, P<Array> const& inScale, Arg inDegree, Z inCycleWidth,
           int inDegreesPerCycle)
...
class DegKeyVZ : public Gen {
 ...
 public:
  DegKeyVZ(Thread& th, P<Array> const& inScale, Arg inDegree, Z inCycleWidth,
           int inDegreesPerCycle)
      : Gen(th, itemTypeV, inDegree.isFinite()),
        _scale(inScale),
        _degree(inDegree),
...
class DegKeyZZ : public Gen {
 ...
 public:
  DegKeyZZ(Thread& th, P<Array> const& inScale, Arg inDegree, Z inCycleWidth,
           int inDegreesPerCycle)
...
class KeyDegVV : public Gen {
 ...
 public:
  KeyDegVV(Thread& th, P<Array> const& inScale, Arg inDegree, Z inCycleWidth,
           int inDegreesPerCycle)
      : Gen(th, itemTypeV, inDegree.isFinite()),
        _scale(inScale),
        _key(inDegree),
...
class KeyDegVZ : public Gen {
 ...
 public:
  KeyDegVZ(Thread& th, P<Array> const& inScale, Arg inDegree, Z inCycleWidth,
           int inDegreesPerCycle)
      : Gen(th, itemTypeV, inDegree.isFinite()),
        _scale(inScale),
        _key(inDegree),
...
class KeyDegZZ : public Gen {
 ...
 public:
  KeyDegZZ(Thread& th, P<Array> const& inScale, Arg inDegree, Z inCycleWidth,
           int inDegreesPerCycle)
      : Gen(th, itemTypeZ, inDegree.isFinite()),
        _scale(inScale),
        _key(inDegree),
...
static Gen* newDegKeyGen(Thread& th, P<Array> const& a, Arg b, Z cycleWidth,
                         int degreesPerCycle) {
  if (b.isVList()) {
...
static Gen* newKeyDegGen(Thread& th, P<Array> const& a, Arg b, Z cycleWidth,
                         int degreesPerCycle) {
  if (b.isVList()) {
...
V do_wrapAt(Thread& th, P<Array> const& a, Arg b) {
  if (b.isReal()) {
    ...
    wrongType("wrapAt : b", "Real or List", b);
...
V do_degkey(Thread& th, P<Array> const& a, Arg b, Z cycleWidth,
  ...
  if (b.isReal()) {
    ...
    wrongType("degkey : b", "Real or List", b);
...
V do_keydeg(Thread& th, P<Array> const& a, Arg b, Z cycleWidth,
  ...
  if (b.isReal()) {
    ...
    wrongType("keydeg : b", "Real or List", b);
...
V do_foldAt(Thread& th, P<Array> const& a, Arg b) {
  if (b.isReal()) {
    ...
    wrongType("foldAt : b", "Real or List", b);
...
V do_clipAt(Thread& th, P<Array> const& a, Arg b) {
  if (b.isReal()) {
    ...
    wrongType("clipAt : b", "Real or List", b);
...
static void wrapAt_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("wrapAt", "");
...
static void degkey_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("degkey", "");
...
static void keydeg_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("keydeg", "");
...
static void foldAt_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("foldAt", "");
...
static void clipAt_(Thread& th, Prim* prim) {
  ...
  if (!s->isFinite()) indefiniteOp("clipAt", "");
...
static P<String> vlistToString(Thread& th, P<List> const& list) {
  if (!list->isFinite()) indefiniteOp("stream to string", "");
...
static P<String> zlistToString(Thread& th, P<List> const& list) {
  if (!list->isFinite()) indefiniteOp("signal to string", "");
...
struct By : public Gen {
  ...
  By(Thread& th, Arg start, Arg step)
      : Gen(th, itemTypeV, false), _start(start), _step(step) {}
...
struct Byz : public Gen {
  ...
  Byz(Thread& th, Z start, Z step)
      : Gen(th, itemTypeZ, false), _start(start), _step(step) {}
...
struct Grow : public Gen {
  ...
  Grow(Thread& th, Arg start, Arg step)
      : Gen(th, itemTypeV, false), _start(start), _step(step) {}
...
struct Growz : public Gen {
  ...
  Growz(Thread& th, Z start, Z step)
      : Gen(th, itemTypeZ, false), _start(start), _step(step) {}
...
struct CubicLine : public Gen {
  ...
  CubicLine(Thread& th, Arg start, Arg step)
      : Gen(th, itemTypeV, false), _start(start), _step(step) {}
...
struct CubicLinez : public Gen {
  ...
  CubicLinez(Thread& th, Z start, Z step)
      : Gen(th, itemTypeZ, false), _start(start), _step(step) {}
...
struct NBy : public Gen {
  ...
  NBy(Thread& th, Arg start, Arg step, int64_t n)
      : Gen(th, itemTypeV, true), _start(start), _step(step), _n(n) {}
...
struct NByz : public Gen {
  ...
  NByz(Thread& th, Z start, Z step, int64_t n)
      : Gen(th, itemTypeZ, true), _start(start), _step(step), _n(n) {}
...
struct NGrow : public Gen {
  ...
  NGrow(Thread& th, Arg start, Arg step, int64_t n)
      : Gen(th, itemTypeV, true), _start(start), _step(step), _n(n) {}
...
struct NGrowz : public Gen {
  ...
  NGrowz(Thread& th, Z start, Z step, int64_t n)
      : Gen(th, itemTypeZ, true), _start(start), _step(step), _n(n) {}
...
struct NCubicLinez : public Gen {
  ...
  NCubicLinez(Thread& th, Z start, Z step, int64_t n)
      : Gen(th, itemTypeZ, true), _start(start), _step(step), _n(n) {}
...
class Perms : public Gen {
 ...
 public:
  Perms(Thread& th, P<Array> const& inItems) : Gen(th, itemTypeV, true) {
  ...
  void getNext() {
    ...
    int i = N - 1;
    while (mOrder[i - 1] >= mOrder[i]) i = i - 1;

    if (i <= 0) return;

    int j = N;
    while (mOrder[j - 1] <= mOrder[i - 1]) j = j - 1;
...
class Permz : public Gen {
 ...
 public:
  Permz(Thread& th, P<Array> const& inItems) : Gen(th, itemTypeV, true) {
    mOrder.reserve(inItems->size());
    mItems.reserve(inItems->size());
    for (int i = 0; i < inItems->size(); ++i) {
...
static void perms_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("perms : list", "");
...
static void permz_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("permz : list", "");
...
class PermsWithRepeatedItemsZ : public Gen {
 ...
 public:
  ...
  virtual const char* TypeName() const override {
    return "PermsWithRepeatedItemsZ";
  }
...
static void permswr_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("permswr : list", "");
...
static void permzwr_(Thread& th, Prim* prim) {
  ...
  if (!a->isFinite()) indefiniteOp("permzwr : list", "");
...
struct Repeat : Gen {
  ...
  Repeat(Thread& th, Arg a, int64_t m)
      : Gen(th, itemTypeV, m < LLONG_MAX), _a(a), _m(m) {}
...
struct RepeatFun : Gen {
  ...
  RepeatFun(Thread& th, Arg a, int64_t m)
      : Gen(th, itemTypeV, m < LLONG_MAX), _a(a), _b(0.), _m(m) {}
...
struct Repeatz : Gen {
  ...
  Repeatz(Thread& th, Z a, int64_t m)
      : Gen(th, itemTypeZ, true), _a(a), _m(m) {}
...
struct RepeatFunz : Gen {
  ...
  RepeatFunz(Thread& th, Arg a, int64_t m)
      : Gen(th, itemTypeZ, true), _a(a), _b(0.), _m(m) {}
...
struct RCyc : public Gen {
  ...
  RCyc(Thread& th, Arg ref, P<List> const& a)
      : Gen(th, a->elemType, false), _ref(ref), _a0(a), _a(a) {}
...
struct Cyc : public Gen {
  ...
  Cyc(Thread& th, P<List> const& a)
      : Gen(th, a->elemType, false), _a0(a), _a(a) {}
...
struct NCyc : public Gen {
  ...
  NCyc(Thread& th, int64_t n, P<List> const& a)
      : Gen(th, a->elemType, true), _a0(a), _a(a), _n(n) {}
...
struct Append : Gen {
  ...
  Append(Thread& th, P<List> const& a, Arg b, bool inFinite)
      : Gen(th, a->elemType, inFinite), _a(a), _b(b) {}
...
struct Cat : Gen {
  ...
  Cat(Thread& th, Arg a, P<List> const& b)
      : Gen(th, itemTypeV, b->isFinite()), _a(a), _b(b) {
    V v;
...
struct CatZ : Gen {
  ...
  // this makes the assumption that all of the sublists of b are finite! if they
  // are not then this will not prevent infinite loops.
  CatZ(Thread& th, Arg a, P<List> const& b)
      : Gen(th, itemTypeZ, b->isFinite()), _a(a), _b(b) {
    V v;
    _b.one(th, v);  // skip over a.
  }
...
struct Flatten : Gen {
  ...
  Flatten(Thread& th, Arg inA, size_t inDepth)
      : Gen(th, itemTypeV, inA.isFinite()), depth(inDepth) {
    VIn vin(inA);
    in.push(vin);
  }
  virtual const char* TypeName() const override { return "Flat"; }
...
struct Keepz : Gen {
  ...
  Keepz(Thread& th, int64_t n, Arg a)
      : Gen(th, itemTypeZ, true), _a(a), _n(n) {}
...
struct Takez : Gen {
  ...
  Takez(Thread& th, int64_t n, Arg a)
      : Gen(th, itemTypeZ, true), _a(a), _n(n) {}
...
struct AppendSubs : Gen {
  ...
  AppendSubs(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeV, mostFinite(a, b)), _a(a), _b(b) {}
  ...
  virtual void pull(Thread& th) override {
    ...
    while (framesToFill) {
      ...
      if (_a(th, n, astride, a) || _b(th, n, bstride, b)) {
        ...
        for (int i = 0; i < n; ++i) {
          SaveStack ss(th);
          if (!a->isList()) wrongType("$$ : *a", "List", *a);
...
static void cat_(Thread& th, Prim* prim) {
  ...
  if (a.isString()) {
    if (!b->isFinite()) indefiniteOp("$/ : list of strings", "");
...
static void flat_(Thread& th, Prim* prim) {
  ...
  if (a.isVList())
    th.push(new List(new Flat(th, a)));
  else
    th.push(a);
}
...
static void flatten_(Thread& th, Prim* prim) {
  ...
  if (a.isVList())
    th.push(new List(new Flatten(th, a, n)));
  else
    th.push(a);
}
...
static void N_(Thread& th, Prim* prim) {
  ...
  if (v.isVList()) {
    if (n <= 0)
      ...
      v = new List(new Keep(th, n, v));
  } else if (v.isZList()) {
    if (n <= 0)
      v = vm._nilz;
    else
      v = new List(new Keepz(th, n, v));
  }
...
static void take_(Thread& th, Prim* prim) {
  ...
  if (n > 0) {
    ...
    if (!s->isFinite()) indefiniteOp("take", "");
...
struct Hops : Gen {
  ...
  Hops(Thread& th, Arg hop, P<List> const& a)
      : Gen(th, itemTypeV, true), _a(a), _hop(hop) {}
...
struct HopTs : Gen {
  ...
  HopTs(Thread& th, Arg hop, P<List> const& a)
      : Gen(th, itemTypeV, true), _a(a), _hop(hop) {}
...
static void drop_(Thread& th, Prim* prim) {
  ...
  if (n == 0) {
    ...
    if (!s->isFinite()) indefiniteOp("drop", "");
...
static void choff_(Thread& th, Prim* prim) {
  ...
  if (a.isVList()) {
    if (!a.isFinite()) indefiniteOp("choff : a", "");
...
struct KeepWhile : Gen {
  ...
  KeepWhile(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeV, true), _a(a), _b(b) {}
...
struct KeepWhileZ : Gen {
  ...
  KeepWhileZ(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeZ, true), _a(a), _b(b) {}
...
struct KeepWhileVZ : Gen {
  ...
  KeepWhileVZ(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeV, true), _a(a), _b(b) {}
...
struct KeepWhileZV : Gen {
  ...
  KeepWhileZV(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeZ, true), _a(a), _b(b) {}
...
struct Tog : Gen {
  ...
  Tog(Thread& th, Arg a, Arg b) : Gen(th, itemTypeV, mostFinite(a, b)), tog(0) {
    _in[0] = a;
    _in[1] = b;
  }
...
struct Togz : Gen {
  ...
  Togz(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeZ, mostFinite(a, b)), _a(a), _b(b) {}
...
struct Tog1 : Gen {
  ...
  Tog1(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeV, mostFinite(a, b)), tog(0) {
    _in[0] = a;
    _in[1] = b;
  }
...
struct Stutter : Gen {
  ...
  Stutter(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeV, mostFinite(a, b)), _a(a), _b(b), n_(0) {}
...
struct Stutterz : Gen {
  ...
  Stutterz(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeZ, mostFinite(a, b)), _a(a), _b(b), n_(0) {}
...
struct Change : Gen {
  ...
  Change(Thread& th, Arg a)
      : Gen(th, itemTypeV, a.isFinite()),
        _a(a),
        _prev(12347918239.19798729839470170) {}
...
struct Expand : Gen {
  ...
  Expand(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeV, a.isFinite()), _a(a), _b(b) {}
...
struct Expandz : Gen {
  ...
  Expandz(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeZ, a.isFinite()), _a(a), _b(b) {}
...
class ShortAs : public Gen {
 ...
 public:
  ShortAs(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeV, mostFinite(a, b)), a_(a), b_(b) {}
...
class ShortAsZ : public Gen {
 ...
 public:
  ShortAsZ(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeZ, mostFinite(a, b)), a_(a), b_(b) {}
...
static void shortas_(Thread& th, Prim* prim) {
  ...
  if (a.isVList() && b.isVList()) {
    ...
    wrongType("shortas : a, b must be same type", "two streams or two signals",
              a);
  }
}
...
class LongAs : public Gen {
 ...
 public:
  LongAs(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeV, b.isFinite()), a_(a), b_(b) {}
...
class LongAsZ : public Gen {
 ...
 public:
  LongAsZ(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeZ, b.isFinite()), a_(a), b_(b) {}
  ...
  void pull(Thread& th) override {
    ...
    while (framesToFill) {
      ...
      int n0 =
          n;  // should ZIn::operator() return n = 0 if it is at end of stream??
      if (a_(th, n, astride, a)) {
        n = n0;
        for (int i = 0; i < n; ++i) {
          out[i] = last;
...
static void longas_(Thread& th, Prim* prim) {
  ...
  if (a.isVList() && b.isVList()) {
    ...
    wrongType("longas : a, b must be same type", "two streams or two signals",
              a);
  }
}
...
class LongAs0Z : public Gen {
 ...
 public:
  LongAs0Z(Thread& th, Arg a, Arg b)
      : Gen(th, itemTypeZ, b.isFinite()), a_(a), b_(b) {}
...
static void longas0_(Thread& th, Prim* prim) {
  ...
  if (a.isVList() && b.isVList()) {
    ...
    wrongType("longas0 : a, b must be same type", "two streams or two signals",
              a);
  }
}
...
static void stop_(Thread& th, Prim* prim) {  // stopPlaying();
}

static void stopDone_(Thread& th, Prim* prim) {  // stopPlayingIfDone();
}

static void interleave(int stride, int numFrames, double* in, float* out) {
  for (int f = 0, k = 0; f < numFrames; ++f, k += stride) out[k] = in[f];
}
...
static void bench_(Thread& th, Prim* prim) {
  ...
  if (v.isZList()) {
    if (!v.isFinite())
      indefiniteOp(">sf : s - indefinite number of frames", "");
    numChannels = 1;
    in[0].set(v);
  } else {
    if (!v.isFinite())
      indefiniteOp(">sf : s - indefinite number of channels", "");
    P<List> s = (List*)v.o();
    s = s->pack(th);
    Array* a = s->mArray();
    numChannels = (int)a->size();
    if (numChannels > kMaxSFChannels) throw errOutOfRange;
    ...
    if (allIndefinite)
      indefiniteOp(">sf : s - all channels have indefinite number of frames",
                   "");
  }
  v.o = nullptr;
...
static void sgram_(Thread& th, Prim* prim) {
  ...
  if (filename.isString()) {
    ...
    snprintf(path, 1024, "%s/%s-%d.jpg", sgramDir, ((String*)filename.o())->s,
             (int)floor(dBfloor + .5));
  } else {
...
void blackman_(Thread& th, Prim* prim) {
  ...
  Eigen::ArrayXd arr = Eigen::ArrayXd::LinSpaced(n, 0, n - 1);
  ZArr outzarr = zarr(out->mArray->z(), n, 1);
  outzarr = 0.42 - .5 * (2.0 * M_PI * arr / n).cos() +
...
struct Segment : public Gen {
  ...
  Segment(Thread& th, Arg in, Arg hop, Arg length)
      : Gen(th, itemTypeV, mostFinite(in, hop, length)),
        in_(in),
        hop_(hop),
        length_(length),
        fracsamp_(0.),
...
struct WinSegment : public Gen {
  ...
  WinSegment(Thread& th, Arg in, Arg hop, P<Array> const& window)
      : Gen(th, itemTypeV, mostFinite(in, hop)),
        in_(in),
        hop_(hop),
        window_(window),
#ifndef SAPF_ACCELERATE
...
static void fft_(Thread& th, Prim* prim) {
  ...
  if (!inReal->isFinite()) indefiniteOp("fft : real", "");

  if (!inImag->isFinite()) indefiniteOp("fft : imag", "");
  ...
  fft(n, inReal->mArray->z(), inImag->mArray->z(), outReal->mArray->z(),
      outImag->mArray->z());
...
static void ifft_(Thread& th, Prim* prim) {
  ...
  if (!inReal->isFinite()) indefiniteOp("ifft : real", "");

  if (!inImag->isFinite()) indefiniteOp("ifft : imag", "");
  ...
  ifft(n, inReal->mArray->z(), inImag->mArray->z(), outReal->mArray->z(),
       outImag->mArray->z());
...
struct Add : Gen {
  ...
  Add(Thread& th, P<List> const& a, Arg b)
      : Gen(th, itemTypeV, a->isFinite()), _a(a), _b(b) {}
...
struct Addz : Gen {
  ...
  Addz(Thread& th, P<List> const& a, Z b)
      : Gen(th, itemTypeZ, a->isFinite()), _a(a), _b(b) {}
...
struct Scan : Gen {
  ...
  Scan(Thread& th, Arg list, Arg fun, Arg val)
      : Gen(th, itemTypeV, list.isFinite()),
        list_(list),
        fun_(fun),
        val_(val) {}
...
struct Scan1 : Gen {
  ...
  Scan1(Thread& th, Arg list, Arg fun)
      : Gen(th, itemTypeV, list.isFinite()),
        list_(list),
        fun_(fun),
        once_(true) {}
...
struct Iter : Gen {
  ...
  Iter(Thread& th, Arg fun, Arg val)
      : Gen(th, itemTypeV, true), fun_(fun), val_(val) {}
...
struct NIter : Gen {
  ...
  NIter(Thread& th, Arg fun, Arg val, int64_t n)
      : Gen(th, itemTypeV, false), fun_(fun), val_(val), n_(n) {}
...
struct Merge : Gen {
  ...
  Merge(Thread& th, Arg a, Arg b, Arg fun)
      : Gen(th, itemTypeV, leastFinite(a, b)), a_(a), b_(b), fun_(fun) {}
...
struct MergeZ : Gen {
  ...
  MergeZ(Thread& th, Arg a, Arg b, Arg fun)
      : Gen(th, itemTypeZ, leastFinite(a, b)), a_(a), b_(b), fun_(fun) {}
...
struct MergeByKey : Gen {
  ...
  MergeByKey(Thread& th, Arg a, Arg b, Arg key)
      : Gen(th, itemTypeV, leastFinite(a, b)), a_(a), b_(b), key_(key) {}
...
struct MergeCmp : Gen {
  ...
  MergeCmp(Thread& th, Arg a, Arg b, Arg fun)
      : Gen(th, itemTypeV, leastFinite(a, b)), a_(a), b_(b), fun_(fun) {}
...
struct MergeCmpZ : Gen {
  ...
  MergeCmpZ(Thread& th, Arg a, Arg b, Arg fun)
      : Gen(th, itemTypeZ, leastFinite(a, b)), a_(a), b_(b), fun_(fun) {}
...
P<Form> extendFormByOne(Thread& th, P<Form> const& parent,
                        P<TableMap> const& tmap, Arg value);
...
struct MergeEvents : Gen {
  ...
  MergeEvents(Thread& th, Arg a, Arg b, Z t)
      : Gen(th, itemTypeV, leastFinite(a, b)), a_(a), b_(b), nextBTime(t) {}
...
static void merge(Thread& th, int64_t an, V* a, int64_t bn, V* b, V* c,
                  CompareFun* compare) {
...
static void merge(Thread& th, int64_t an, Z* a, int64_t bn, Z* b, Z* c,
                  ZCompareFun* compare) {
  // merge a and b using scratch space c.
  // copy result back to a.
  // a and b are assumed to be contiguous.
...
static void mergesort(Thread& th, int64_t n, V* a, V* tmp,
                      CompareFun* compare) {
  if (n == 1) return;
  int64_t an = n / 2;
  int64_t bn = n - an;
...
static void mergesort(Thread& th, int64_t n, Z* a, Z* tmp,
                      ZCompareFun* compare) {
  if (n == 1) return;
  int64_t an = n / 2;
  int64_t bn = n - an;
...
static void sort(Thread& th, int64_t n, const V* in, V* out,
                 CompareFun* compare) {
  V* tmp = new V[n];
...
static void sort(Thread& th, int64_t n, const Z* in, Z* out,
                 ZCompareFun* compare) {
  Z* tmp = new Z[n];
...
static void merge(Thread& th, int64_t an, V* a, Z* az, int64_t bn, V* b, Z* bz,
                  V* c, Z* cz, CompareFun* compare) {
  // merge a and b using scratch space c.
  // copy result back to a.
  // a and b are assumed to be contiguous.
  int64_t ai = 0;
...
static void merge(Thread& th, int64_t an, Z* a, Z* az, int64_t bn, Z* b, Z* bz,
                  Z* c, Z* cz, ZCompareFun* compare) {
  // merge a and b using scratch space c.
  // copy result back to a.
  // a and b are assumed to be contiguous.
  int64_t ai = 0;
...
static void mergesort(Thread& th, int64_t n, V* a, Z* az, V* c, Z* cz,
                      CompareFun* compare) {
  if (n == 1) return;
  int64_t an = n / 2;
  int64_t bn = n - an;
...
static void mergesort(Thread& th, int64_t n, Z* a, Z* az, Z* c, Z* cz,
                      ZCompareFun* compare) {
  if (n == 1) return;
  int64_t an = n / 2;
  int64_t bn = n - an;
...
static void grade(Thread& th, int64_t n, const V* in, Z* zout,
                  CompareFun* compare) {
  V* out = new V[n];
  V* tmp = new V[n];
  Z* ztmp = new Z[n];
...
static void grade(Thread& th, int64_t n, const Z* in, Z* zout,
                  ZCompareFun* compare) {
  Z* out = new Z[n];
  Z* tmp = new Z[n];
  Z* ztmp = new Z[n];
...
static void sort_(Thread& th, Prim* prim) {
  ...
  if (!a.isFinite()) indefiniteOp("sort : a", "");
...
static void grade_(Thread& th, Prim* prim) {
  ...
  if (!a.isFinite()) indefiniteOp("grade : a", "");
...
#define DEF(NAME, TAKES, LEAVES, HELP) \
  vm.def(#NAME, TAKES, LEAVES, NAME##_, HELP);
#define DEFMCX(NAME, N, HELP) vm.defmcx(#NAME, N, NAME##_, HELP);
#define DEFAM(NAME, MASK, HELP) vm.defautomap(#NAME, #MASK, NAME##_, HELP);
#define DEFnoeach(NAME, TAKES, LEAVES, HELP) \
  vm.def(#NAME, TAKES, LEAVES, NAME##_, HELP, V(0.), true);
#define DEFN(NAME, TAKES, LEAVES, FUN, HELP) \
  vm.def(NAME, TAKES, LEAVES, FUN, HELP);
#define DEFNnoeach(NAME, TAKES, LEAVES, FUN, HELP) \
  vm.def(NAME, TAKES, LEAVES, FUN, HELP, V(0.), true);
...
void AddStreamOps() {
  ...
  DEF(L, 1, 1,
      "(anything --> stream) streams are returned as is. anything else is made "
      "into an infinite stream of itself.")
  DEF(L1, 1, 1,
      "(anything --> stream) streams are returned as is. anything else is "
      "wrapped in a one item list.")
  DEF(unspell, 1, 1,
      "(sequence --> string) converts a stream of numbers or a signal to a "
      "string.")

  vm.addBifHelp("\n*** basic list operations ***");

  DEF(size, 1, 1,
      "(seq --> num) Return the length of a sequence if it is finite. Returns "
      "inf if the sequence is of indefinite length (It may not actually be "
      "infinitely long).")
  DEF(rank, 1, 1,
      "(a --> n) Return the rank of an object. Makes the assumption that lists "
      "at all depths are homogenous.")
  DEF(shape, 1, 1,
      "(a --> [n..]) Return the shape of an object. Axes of indefinite length "
      "are represented by inf. Makes the assumption that lists at all depths "
      "are homogenous.")
  DEF(finite, 1, 1,
  ...
  DEF(add, 2, 1,
      "(list item --> list) returns a new list with the item added to the end.")
  DEF(cons, 2, 1,
      "(list item --> list) returns a new list with the item added to the "
      "front.")
  DEF(uncons, 1, 2,
      "(list --> tail head) returns the tail and head of a list. fails if list "
      "is empty.")
  ...
  DEFnoeach(
      ord, 0, 1,
      "(--> series) return an infinite series of integers ascending from "
      "1.") DEFnoeach(nat, 0, 1,
                      "(--> series) return an infinite series of "
                      "integers ascending from 0.") DEFnoeach(invs, 0, 1,
                                                              "(--> "
                                                              "series) "
                                                              "return an "
                                                              "infinite "
                                                              ...
                                                              "1/") DEFnoeach(negs,
                                                                              0,
                                                                              1,
                                                                              "(--> series) return an infinite series of integers descending "
                                                                              "from -1.")
      DEFnoeach(
          evens, 0, 1,
          "(--> series) return an infinite series "
          "of ascending non-negative even "
          "integers.") DEFnoeach(odds, 0, 1,
                                 "(--> series) "
                                 "return an "
                                 "infinite series "
                                 "of ascending "
                                 "non-negative odd "
                                 "integers.") DEFnoeach(ints, 0, 1,
                                                        "(--> series) "
                                                        "return the "
                                                        "infinite series "
                                                        "[0 1 -1 2 -2 3 "
                                                        "-3...]") DEFnoeach(primes,
                                                                            ...
                                                                            ".") DEFAM(fib,
                                                                                       kk,
                                                                                       "(a b --> series) returns a fibonacci series "
                                                                                       "starting with the two numbers given.")

          DEFnoeach(ordz, 0, 1,
                    "(--> signal) return an infinite signal of integers "
                    "ascending from 1.") DEFnoeach(natz, 0, 1,
                                                   "(--> signal) return an "
                                                   "infinite signal of "
                                                   "integers ascending "
                                                   "from 0.") DEFnoeach(invz, 0,
                                                                        1,
                                                                        "(-"
                                                                        "->"
                                                                        " s"
              ...
              DEFnoeach(
                  negz, 0, 1,
                  "(--> signal) return an infinite signal of integers "
                  "descending from -1.") DEFnoeach(evenz, 0, 1,
                                                   "(--> signal) return an "
                                                   "infinite signal of "
                                                   "ascending non-negative "
                                                   "even integers.") DEFnoeach(oddz,
                                                                               0,
                                                                               1,
                                                                               "(--> signal) return an infinite "
                                                                               "signal of ascending "
                                                                               "non-negative odd integers.")
                  DEFnoeach(
                      intz, 0, 1,
                      "(--> signal) return the infinite signal [0 1 "
                      "-1 2 -2 3 -3...]") DEFnoeach(primez, 0, 1,
                                                    "(--> signal) "
                                                    "returns a "
                                                    "finite signal "
                                                    "of prime "
                                                    "numbers up to "
                                                    "1000039.") DEFMCX(fibz, 2,
                                                                       "(a b "
                                                                       "--> "
                                                                       "signal)"
                                                                       " return"
                      ...
                      DEFAM(
                          ninvs, k,
                          "(n --> stream) return a finite stream of n "
                          "reciprocals. equivalent to n 1 1 nby 1/") DEFMCX(ninvz,
                                                                            1,
                                                                            "(n"
                                                                            " -"
                                                                            "->"
                          ...
                          DEF(ever, 1, 1,
                              "(value --> series) return an infinite "
                              "stream of value.") DEFAM(by, kk,
                                                        "(start step --> "
                                                        "series) return an "
                                                        "infinite "
                                                        "arithmetic "
                              ...
                              DEFAM(
                                  grow, kk,
                                  "(start step --> series) return an infinite "
                                  "geometric series.") DEFAM(ngrow, kkk,
                                                             "(n start step "
                                                             "--> series) "
                                                             "return a "
                                                             "finite geometric "
                                  ...
                                  DEFMCX(
                                      everz, 1,
                                      "(value --> signal) return an "
                                      "infinite signal of value.") DEFMCX(byz,
                                                                          2,
                                                                          "(sta"
                                                                          "rt "
                                                                          "step"
                                      ...
                                      DEFMCX(
                                          nbyz, 3,
                                          "(n start step --> series) "
                                          "return a finite arithmetic "
                                          "series as a signal.") DEFMCX(growz,
                                                                        2,
                                                                        "(s"
                                                                        "ta"
                                                                        "rt"
                                          ...
                                          DEFMCX(ngrowz, 3,
                                                 "(n start step --> "
                                                 "series) return a finite "
                                                 "geometric series as a "
                                                 "signal.") DEFMCX(toz, 2,
                                                                   "(a b "
                                                                   "--> "
                                                                   "series)"
                                                              ...
                                                              DEFMCX(
                                                                  ...
                                                                  DEFMCX(
                                                                      ...
                                                                      DEFMCX(
                                                                          ...
                                                                          ".")  // mcx
      DEFMCX(xline, 3,
             "(dur start end --> z) return a signal ramping exponentially from "
             "start to end in dur seconds.")  // mcx

      vm.addBifHelp("\n*** list reduction operations ***");
  DEFAM(reduce, aak,
        "(list value fun --> value) applies fun to each item in list and the "
        "current value to get a new value. returns the ending value.")
  DEFAM(reduce1, ak,
        "(list fun --> value) like reduce except that the initial value is the "
        "first item in the list.")

  DEFAM(scan, aak,
        "(list value fun --> list) applies fun to each item in list and the "
        "current value to get a new value, which is added to the output list.")
  DEFAM(scan1, ak,
        "(list fun --> list) like scan except that the initial value is the "
        "first item in the list.")
  DEFAM(iter, ak,
        "(value fun --> list) returns an infinite list of repeated "
        "applications of fun to value.")
  DEFAM(itern, akk,
        "(value fun n --> list) returns a list of n repeated applications of "
        "fun to value.")

  DEFAM(chain, akk,
        "(value fun n --> list) returns the result of n repeated applications "
        "of fun to value.")
  ...
  DEF(rcyc, 1, 1,
      "(ref --> list) gets a new list from ref each time list is exhausted.")

  vm.defautomap(
      "X", "ak", repeat_,
      "(value n --> stream) makes a list containing n copies of value. If "
      "value is a function, then the results of applying the function with an "
      "integer count argument is used as the contents of the output list.");
  vm.defmcx(
      "XZ", 2, repeatz_,
      "(value n --> signal) returns a signal with value repeated n times.");
  vm.defmcx("mum", 1, mum_,
            "(t --> signal) returns a signal of t seconds of silence.");

  vm.def("$", 2, 1, append_,
         "(listA listB --> out) returns the concatenation of listA and listB.");
  vm.defmcx("$z", 2, append_,
            "(signalA signalB --> signal) returns the concatenation of signalA "
            "and signalB.");

  vm.def("$$", 2, 1, appendSubs_,
         "(listA listB --> out) return the concatenation of the sublists of "
         "listA and listB. equivalent to (listA @ listB @ $)");
  vm.def("$/", 1, 1, cat_,
         "(list --> out) returns the concatenation of the sub-lists of the "
         "input list.");
  DEF(flat, 1, 1, "(list --> list) flattens a list.")
  DEFAM(flatten, ak, "(list n --> list) makes a list n levels flatter.")
  vm.defautomap("keep", "ak", N_,
                "(list n --> list) returns a list of the first n items of the "
                "input list.");

  DEFAM(T, zk,
        "(signal t --> signal) returns a signal of the first t seconds of the "
        "input signal.");
  vm.defautomap(
      "T>", "zk", skipT_,
      "(signal t --> signal) skips the first t seconds of the input signal.");
  vm.defautomap("N>", "ak", skip_,
                "(list n --> list) skips the first n items of the input list.");
  vm.def("N>>", 2, 1, hops_,
         "(list hops --> listOfLists) returns a list of tails of the input "
         "list. equivalent to (list (hops 0 | L 0 cons +\\) N>).");
  vm.defautomap(
      "T>>", "za", hopTs_,
      "(signal hops --> listOfSignals) returns a list of tails of the input "
      "list. equivalent to (signal (hops 0 | L 0 cons +\\) T>).");
  DEFAM(N, ak,
        "(list n --> list) returns a list of the first n items of the input "
        "list.")
  DEFAM(NZ, zk,
        "(signal n --> signal) returns a signal of the first n items of the "
        "input signal. automaps over streams.")
  ...
  DEFAM(take, ak,
        "(list n --> list) returns a list of the first n items of the input "
        "list, or the last n items if n is negative and the list is finite.")
  DEFAM(drop, ak,
        "(list n --> list) skips the first n items of the input list, or the "
        "last n items if n is negative and the list is finite.")

  DEFAM(choff, akk,
        "(channel(s) c n --> out) takes a finite list of channels or a single "
        "signal and places it into an array of n channels beginning at offset "
        "c. Other channels are set to zero.");

  DEF(tog, 2, 1,
      "(a b --> series) return a series alternating between a and b.")
  DEFMCX(togz, 2,
         "(a b --> signal) return a signal alternating between a and b.")
  DEF(sel, 2, 1,
      "(a j --> out) select. a is a list of lists. out[i] is a[j][i]")
  DEF(sell, 2, 1,
      "(a j --> out) lazy select. a is a list of lists. out[i] is the next "
      "value from a[j].")

  vm.def("?", 2, 1, filter_,
         "(a b --> out) the output list contains a[i] repeated b[i] times. If "
         "b is a list of booleans (1 or 0) then this functions as a filter.");
  DEF(spread, 2, 1, "(a n --> out) inserts n[i] zeroes after a[i].")
  DEFMCX(spreadz, 2,
         "(a n --> signal) inserts n[i] zeroes after a[i]. automaps over "
         "stream inputs.")

  DEF(change, 1, 1,
      "(a --> b) eliminates sequential duplicates in a signal or stream.")
  DEFMCX(changez, 1,
         "(a --> b) eliminates sequential duplicates in a signal. automaps "
         "over streams.")
  DEF(expand, 2, 1,
      "(a b --> out) when b is true, a value from a is written to out, when b "
      "is false, zero is written to out.")
  DEFMCX(expandz, 2,
         "(a b --> out) when b is true, a value from a is written to out, when "
         "b is false, zero is written to out. automaps over stream inputs.")

  DEF(clump, 2, 1,
      "(a n --> out) groups elements from list a into sub-lists of size n.")
  DEF(hang, 1, 1,
      "(a --> out) repeats the last value of a finite list indefinitely.")
  DEFMCX(hangz, 1,
         "(a --> out) repeats the last value of a finite signal indefinitely. "
         "automaps over streams.")
  DEFAM(histo, ak, "(a n --> out) makes a histogram of the finite stream a.")
  vm.defautomap("histoz", "zk", histo_,
                "(a n --> out) makes a histogram of the finite signal a. "
                "automaps over streams.");

  DEF(keepWhile, 2, 1,
      "(a b --> out) return items from a while items from b are true.")
  DEF(skipWhile, 2, 1,
      "(a b --> out) skip items from a while items from b are true.")

  DEF(flop, 1, 1,
      "(a --> b) returns the transpose of the list of lists a. At least one of "
      "the dimensions must be finite.")
  DEF(flops, 1, 1,
      "(a --> b) like flop, but signals are treated as scalars and not "
      "flopped.")
  DEF(flop1, 1, 1,
      "(a --> b) like flop, but if list a is not a list of lists then it is "
      "wrapped in a list. compare: [[1 2 3][[4 5] 6 7]] @ flop $/ with: [[1 2 "
      "3][[4 5] 6 7]] @ flop1 $/")
  DEF(lace, 1, 1,
      "(a --> b) returns the concatenation of the transpose of the list of "
      "lists a.")
  DEFAM(merge, aak,
        "(a b fun --> c) merges two lists according to the function given. The "
        "function should work like <.")
  DEFAM(mergec, aak,
        "(a b fun --> c) merges two lists without duplicates according to the "
        "function given. The function should work like cmp.")

  DEF(perms, 1, 1,
      "(a --> b) returns a list of all permutations of the input list.")
  DEFMCX(permz, 1,
         "(a --> b) returns a list of all permutations of the input signal. "
         "automaps over streams.")

  DEF(permswr, 1, 1,
      "(a --> b) returns a list of all unique permutations of an input stream "
      "with repeated elements.")
  DEFMCX(permzwr, 1,
         "(a --> b) returns a returns a list of all unique permutations of an "
         "input signal with repeated elements. automaps over streams.")

  DEF(shortas, 2, 1, "(a b --> a') makes list a as short as list b.")
  DEF(longas, 2, 1,
      "(a b --> a') makes list a as long as list b by repeating the last item.")
  DEF(longas0, 2, 1,
      "(a b --> a') makes list a as long as list b by appending zeroes.")
  ...
  DEF(bub, 1, 1,
      "(a --> [a]) makes the top item on the stack into a one item list. i.e. "
      "puts a bubble around it.")
  DEF(nbub, 2, 1,
      "(a n --> [[..[a]..]]) embeds the top item in N one item lists.")

  vm.def("2ple", 2, 1, tupleN_<2>,
         "(a b --> [a b]) make a pair from the top two stack items.");
  vm.def("3ple", 3, 1, tupleN_<3>,
         "(a b c --> [a b c]) make a triple from the top three stack items.");
  vm.def("4ple", 4, 1, tupleN_<4>,
         "(a b c d --> [a b c d]) make a quadriple from the top four stack "
         "items.");
  vm.def("5ple", 5, 1, tupleN_<5>,
         "(a b c d e --> [a b c d e]) make a quintuple from the top five stack "
         "items.");
  vm.def("6ple", 6, 1, tupleN_<6>,
         "(a b c d e f --> [a b c d e f]) make a sextuple from the top six "
         "stack items.");
  vm.def("7ple", 7, 1, tupleN_<7>,
         "(a b c d e f g --> [a b c d e f g]) make a septuple from the top "
         "seven stack items.");
  vm.def("8ple", 8, 1, tupleN_<8>,
         "(a b c d e f g h --> [a b c d e f g h]) make an octuple from the top "
         "eight stack items.");

  vm.defautomap("2ples", "kk", tupleN_<2>,
                "(a b --> [[a0 b0][a1 b1]..[aN bN]]) make a sequence of pairs "
                "from the sequences a and b.");
  vm.defautomap("3ples", "kkk", tupleN_<3>,
                "(a b c --> [[a0 b0 c0][a1 b1 c1]..[aN bN cN]]) make a "
                "sequence of triples from the sequences a, b and c.");
  vm.defautomap("4ples", "kkkk", tupleN_<4>,
                "(a b c d --> seq) make a sequence of quadruples from the "
                "sequences a, b, c and d.");
  vm.defautomap("5ples", "kkkkk", tupleN_<5>,
                "(a b c d e --> seq) make a sequence of quintuples from the "
                "sequences a through e.");
  vm.defautomap("6ples", "kkkkkk", tupleN_<6>,
                "(a b c d e f--> seq) make a sequence of sextuples from the "
                "sequences a through f.");
  vm.defautomap("7ples", "kkkkkkk", tupleN_<7>,
                "(a b c d e f g--> seq) make a sequence of septuples from the "
                "sequences a through g.");
  vm.defautomap("8ples", "kkkkkkkk", tupleN_<8>,
                "(a b c d e f g h --> seq) make a sequence of octuples from "
                "the sequences a through h.");

  DEFNnoeach("un2", 1, 2, untupleN_<2>,
             "([a0 a1 .. aN-1] --> a0 a1) Push two items from a sequence onto "
             "the stack.") DEFNnoeach("un3", 1, 3, untupleN_<3>,
                                      "([a0 a1 .. aN-1] --> a0 a1 a2) Push "
                                      "three items from a sequence onto the "
                                      "stack.") DEFNnoeach("un4", 1, 4,
                                                           untupleN_<4>,
                                                           "([a0 a1 .. aN-1] "
                                                           "--> a0 a1 a2 a3) "
                                                           "Push four items "
      ...
      DEFNnoeach(
          "un5", 1, 5, untupleN_<5>,
          "([a0 a1 .. aN-1] --> a0 a1 a2 a3 a4) Push five items from a "
          "sequence onto the stack.") DEFNnoeach("un6", 1, 6, untupleN_<6>,
                                                 "([a0 a1 .. aN-1] --> a0 a1 "
                                                 "a2 .. a5) Push six items "
                                                 "from a sequence onto the "
                                                 "stack.")
          DEFNnoeach(
              "un7", 1, 7, untupleN_<7>,
              "([a0 a1 .. aN-1] --> a0 a1 a2 .. a6) Push seven items from a "
              "sequence onto the stack.") DEFNnoeach("un8", 1, 8, untupleN_<8>,
                                                     "([a0 a1 .. aN-1] --> a0 "
                                                     "a1 a2 .. a7) Push eight "
                                                     "items from a sequence "
                                                     "onto the stack.")

              DEF(reverse, 1, 1, "(a --> b) reverses a finite sequence.") DEF(
                  mirror0, 1, 1,
                  "(a --> b) cyclic mirror of a sequence. [1 2 3 4] --> [1 2 3 "
                  "4 3 2]") DEF(mirror1, 1, 1,
                                "(a --> b) odd mirror of a sequence. [1 2 3 4] "
                                "--> [1 2 3 4 3 2 1]")
                  DEF(mirror2, 1, 1,
                      "(a --> b) even mirror of a sequence. [1 2 3 4] --> [1 2 "
                      "3 4 4 3 2 1]") DEFAM(rot, ak,
                                            "(seq M --> seq') rotation of a "
                                            "sequence by M places. M > 0 moves "
                                            "right.")
                      DEFAM(shift, ak,
                            "(seq M --> seq') shift of a sequence by M places. "
                            "zeroes are shifted in to fill vacated positions.")
                          DEFAM(clipShift, ak,
                                "(seq M --> seq') shift of a sequence by M "
                                "places. the end value is copied in to fill "
                                "vacated positions.")
                              DEFAM(foldShift, ak,
                                    "(seq M --> seq') shift of a sequence by M "
                                    "places. values from the cyclic mirrored "
                                    "sequence are copied in to fill vacated "
                                    "positions.") DEF(muss, 1, 1,
                                                      "(a --> b) puts a finite "
                                                      "sequence into a random "
                                                      "order.")

                                  DEF(at, 2, 1,
                                      "(seq index(es) --> value(s)) looks up "
                                      "item(s) in sequence at index(es). out "
                                      "of range indexes return zero.")
                                      DEF(wrapAt, 2, 1,
                                          "(seq index(es) --> value(s)) looks "
                                          "up item(s) in sequence at "
                                          "index(es). out of range indexes "
                                          "return the value at the end point.")
                                          DEF(foldAt, 2, 1,
                                              "(seq index(es) --> value(s)) "
                                              "looks up item(s) in sequence at "
                                              "index(es). out of range indexes "
                                              "return the items from the "
                                              "cyclic sequence.")
                                              DEF(clipAt, 2, 1,
                                                  "(seq index(es) --> "
                                                  "value(s)) looks up item(s) "
                                                  "in sequence at index(es). "
                                                  "out of range indexes return "
                                                  "items from the cyclic "
                                                  "mirrored sequence.")
                                                  DEF(degkey, 2, 1,
                                                      "(degree scale --> "
                                                      "converts scale "
                                                      ...
                                                      "given a scale");
  DEF(keydeg, 2, 1,
      "(key scale --> converts key(s) to scale degree(s), given a scale");

  DEF(sort, 1, 1, "(in --> out) ascending order sort of the input list.");
  DEFAM(sortf, ak,
        "(in fun --> out) sort of the input list using a compare function.");
  DEFN("sort>", 1, 1, sort_gt_,
       "(in --> out) descending order sort of the input list.");

  DEF(grade, 1, 1,
      "(in --> out) ascending order sorted indices of the input list.");
  DEFAM(gradef, ak,
        "(in fun --> out) sorted indices of the input list using a compare "
        "function.");
  DEFN("grade>", 1, 1, grade_gt_,
       "(in --> out) descending order sorted indices of the input list.");

  vm.addBifHelp("\n*** event list operations ***");
  DEFAM(evmerge, aak,
        "(a b t --> c) merges event list 'b' with delay 't' with event list "
        "'a' according to their delta times")
  DEFAM(evdelay, ak,
        "(a t --> c) delay an event list by adding a preceeding rest of "
        "duration 't'")
  ...
  DEFMCX(kaiser, 2,
         "(n stopBandAttenuation --> out) returns a signal filled with a "
         "kaiser window with the given stop band attenuation.")
  DEFMCX(hanning, 1,
         "(n --> out) returns a signal filled with a Hanning window.")
  DEFMCX(hamming, 1,
         "(n --> out) returns a signal filled with a Hamming window.")
  DEFMCX(blackman, 1,
         "(n --> out) returns a signal filled with a Blackman window.")
  DEFMCX(fft, 2,
         "(re im --> out) returns the complex FFT of two vectors (one real and "
         "one imaginary) which are a power of two length.")
  DEFMCX(ifft, 2,
         "(re im --> out) returns the complex IFFT of two vectors (one real "
         "and one imaginary) which are a power of two length.")

  DEFAM(seg, zaa,
        "(in hops durs --> out) divide input signal in to a stream of signal "
        "segments of given duration stepping by hop time.")
  DEFAM(wseg, zaz,
        "(in hops window --> out) divide input signal in to a stream of "
        "windowed signal segments of lengths equal to the window length, "
        "stepping by hop time.")

  vm.addBifHelp("\n*** audio I/O operations ***");
  DEF(play, 1, 0, "(channels -->) plays the audio to the hardware.")
  // DEF(record, 2, 0,
  //     "(channels filename -->) plays the audio to the hardware and records it
  //     " "to a file.")
  DEFnoeach(stop, 0, 0, "(-->) stops any audio playing.")
      //     vm.def("sf>", 1, 0, sfread_,
      //            "(filename -->) read channels from an audio file. not real
      //            time.");
      // vm.def(">sf", 2, 0, sfwrite_,
      //        "(channels filename -->) writes the audio to a file.");
      // vm.def(">sfo", 2, 0, sfwriteopen_,
      //        "(channels filename -->) writes the audio to a file and opens it
      //        in " "the default application.");
      // vm.def("sf>", 2, sfread_);
      DEF(bench, 1, 0,
          "(channels -->) prints the amount of CPU required to compute a "
          "segment "
          "of audio. audio must be of finite duration.")
#ifdef SAPF_AUDIOTOOLBOX
          vm.def("sgram", 3, 0, sgram_,
                 "(signal dBfloor filename -->) writes a spectrogram to a file "
                 "and "
                 "opens it.");
#endif  // SAPF_AUDIOTOOLBOX
